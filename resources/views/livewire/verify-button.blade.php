<div>
    ...
    @if($isVerified)
    <button type="button" class="mmbr_stt tick">
    ...
    <button type="button" class="mmbr_stt cross" wire:click.prevent="verifyUser('{{$userId}}')">
...
<input type="checkbox" wire:model="isVerified" name="" id="">