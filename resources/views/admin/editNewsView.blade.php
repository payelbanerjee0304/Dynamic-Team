...
<div class="otr">
    <div class="container">
      <div class="south_jst">
        <div class="mul_form">
          <div class="multi_top_dir">Edit News</div>
          ...
          <div class="progress_bar">
            ...
            <form action="javascript:void(0)" method="POST" id="dynamic-form">
                    ...
                    <div class="frm_cnt" id="frm_cnt1">
                        ...
                        <div class="frm_row">
                            <label>Title</label>
                            <input type="text" name="title" id="title" placeholder="Enter title"  value="{{ $newsDetails['title'] ?? '' }}" />
                            <small class="error-message" id="title_error"></small>
                        </div>
                        <div class="frm_row">
                            <label>Content</label>
                            <textarea class="mt_dscrb_bx" id="content" name="content" placeholder="Enter content" style="width: 100%;">{!! $newsDetails['content'] ?? '' !!}</textarea>
                        ...
                        <div class="frm_row">
                            ...
                            <img id="croppedImage" class="croppedImage" alt="Cropped Image" style="display: block;max-width: 100%; margin-top: 20px;" src="{{ $newsDetails['image'] ?? asset('images/no-img.png') }}">

                            <input id="logoFile" name="logoFile" type="file" hidden />
                            <input id="logoFileName" name="logoFileName" class="logoFileName" type="hidden" value="{{ $newsDetails['image'] ?? '' }}" />
                        ...
                        <div class="frm_row">
                            ...
                            <div id="croppedImagesContainer" style="margin-top: 20px;">
                                @if(isset($newsDetails['otherImages']) && is_array($newsDetails['otherImages']))
                                    @foreach($newsDetails['otherImages'] as $image)
                                        <div style="display: flex; align-items: center; margin: 5px;">
                                            <img src="{{ $image }}" class="croppedImage" style="max-width: 100px;" alt="Existing Image">
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                        ...
                        <div class="frm_row">
                            ...
                            <input type="date" class="inpt dates" id="startDate" name="startDate" placeholder="" style="cursor: pointer;" value="{{ DateTime::createFromFormat('Ymd', $newsDetails['startDate'])->format('Y-m-d') }}" />
                            <small class="error-message" id="startDate_error"></small>
                        </div>
                        <div class="frm_row">
                            <label>End Date</label>
                            <input type="date" class="inpt dates" id="endDate" name="endDate" placeholder="" style="cursor: pointer;" value="{{ DateTime::createFromFormat('Ymd', $newsDetails['endDate'])->format('Y-m-d') }}" />
    ...
    <script>
        ...
        $(document).on("click", "#submitBtn", function() {
            ...
            if (formValidated) {
                ...
                const croppedImagesData = $("#logoFileData1").val();
