      ...
      <div class="mul_form">
        ...
        <form action="{{ route('admin.updateMember') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="frm_row">
            ...
            <input type="checkbox" name="isVerified" id="isVerified" {{ isset($member['isVerified']) && $member['isVerified'] == "Yes" ? 'checked disabled' : ''}} />
          </div>
      </div>
      <div class="btn_frm">
        ...
        <a href="{{route('admin.editMember', ['id' => $member['_id']])}}" class="cmn_btn gre" id="resetBtn" style="display: none;">Reset</a>
