...
<div class="otr">
    <div class="container">
      <div class="south_jst editor">
        <div class="mul_form">
          <div class="multi_top_dir">Clone Team</div>
            <form action="{{ route('admin.cloneTeam') }}" method="POST" id="dynamic-form">
                    @csrf
                    ...
                    <div class="btn_frm">
                        <input type="submit" class="cmn_btn" id="submitBtn" value="Clone">
                    </div>
            </form>
        </div>
      </div>
